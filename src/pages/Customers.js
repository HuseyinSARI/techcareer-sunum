...
function Customers() {
  ...
  const columns = [
    ...
    },
    {
      title: 'Update',
      dataIndex: 'id',
      render: (id) => <Button onClick={() => handleUpdateNavigate(id)} type='primary-outline' danger>Update</Button>
    },
    {
      title: 'Detail',
      dataIndex: 'id',
      render: (id) => <Button onClick={() => handleDetailNavigate(id)} type='primary-outline' danger>Detail</Button>
    },
  ];
